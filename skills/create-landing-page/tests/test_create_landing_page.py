"""Smoke tests for create-landing-page."""
import json
import subprocess
import sys
...
def setup_module():
    FIXTURE.write_text(json.dumps({"intention": "landing page para fintech"}, ensure_ascii=False), encoding="utf-8")
...
def test_output_schema():
    ...
    output = json.loads(result.stdout)
    for key in ["template_dir", "files", "sections", "next_action"]:
