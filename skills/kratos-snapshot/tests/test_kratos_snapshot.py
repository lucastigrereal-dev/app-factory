"""Smoke tests for kratos-snapshot."""
import json
import subprocess
import sys
...
def setup_module():
    FIXTURE.write_text(json.dumps({"project_id": "proj-123", "phase": "blueprint-complete", "cost": 1234.56, "risk": "low", "approval": True}, ensure_ascii=False), encoding="utf-8")
...
def test_output_schema():
    ...
    for key in ["snapshot_id", "project_id", "timestamp", "phase", "status", "cost", "risk", "approval"]:
