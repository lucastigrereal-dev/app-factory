"""Testes de fumaça para app-factory-api-contractor."""
...
def test_dry_run_outputs_api():
    ...
    assert "api_contract_yaml" in output
...
def test_output_schema():
    ...
    output = json.loads(result.stdout)
    required = ["api_contract_yaml", "report", "endpoints", "version", "auth_scheme", "next_action"]
    for key in required:
